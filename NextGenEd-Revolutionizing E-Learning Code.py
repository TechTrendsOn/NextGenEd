# -*- coding: utf-8 -*-
"""NextGenEd_Revolutionizing_E_Learning.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1f6aHLXkYUFE9wopn5bv1WuFyv0r1sCQY
"""
...
explanation providing complete details.If the uploaded image does not appear
to be contextually relevant (e.g., not scientific, educational, or related to
a field of study) and lacks identifiable academic or conceptual information,
respond with a message stating The uploaded image could not be classified based
on contextual or educational relevance. Please upload a diagram or figure
related to a specific topic or field of study for further analysis. If the user
uses offensive or inappropriate language, do not engage in conflict. Instead,
gently redirect the conversation by saying Let’s stay focused on the topic
related to the image and keep the discussion respectful.
